...
namespace RevitExporter
{
    class MyExportContext : IExportContext
    {
        ...
        private void WriteXmlGeometrySourcePositions(PolymeshTopology polymesh)
        {
            ...
            streamWriter.Write("<float_array id=\"geom-" + CurrentPolymeshIndex + "-positions" + "-array" +
                               "\" count=\"" + (polymesh.NumberOfPoints * 3) + "\">\n");
            ...
            streamWriter.Write("<accessor source=\"#geom-" + CurrentPolymeshIndex + "-positions" + "-array\"" +
                               " count=\"" + polymesh.NumberOfPoints + "\" stride=\"3\">\n");
        ...
        private void WriteXmlGeometrySourceNormals(PolymeshTopology polymesh)
        {
            ...
            streamWriter.Write("<float_array id=\"geom-" + CurrentPolymeshIndex + "-normals" + "-array" +
                               "\" count=\"" + (nNormals * 3) + "\">\n");
            ...
            streamWriter.Write("</float_array>\n");
            streamWriter.Write("<technique_common>\n");
            streamWriter.Write("<accessor source=\"#geom-" + CurrentPolymeshIndex + "-normals" + "-array\"" +
                               " count=\"" + nNormals + "\" stride=\"3\">\n");
            streamWriter.Write("<param name=\"X\" type=\"float\"/>\n");
            streamWriter.Write("<param name=\"Y\" type=\"float\"/>\n");
            streamWriter.Write("<param name=\"Z\" type=\"float\"/>\n");
            streamWriter.Write("</accessor>\n");
        ...
        private void WriteXmlGeometrySourceMap(PolymeshTopology polymesh)
        {
            ...
            streamWriter.Write("<float_array id=\"geom-" + CurrentPolymeshIndex + "-map" + "-array" + "\" count=\"" +
                               (polymesh.NumberOfUVs * 2) + "\">\n");
            ...
            streamWriter.Write("</float_array>\n");
            streamWriter.Write("<technique_common>\n");
            streamWriter.Write("<accessor source=\"#geom-" + CurrentPolymeshIndex + "-map" + "-array\"" + " count=\"" +
                               polymesh.NumberOfPoints + "\" stride=\"2\">\n");
        ...
        private void WriteXmlGeometryTrianglesWithoutMap(PolymeshTopology polymesh)
        {
            ...
            streamWriter.Write(">\n");
            streamWriter.Write("<input offset=\"0\" semantic=\"VERTEX\" source=\"#geom-" + CurrentPolymeshIndex +
                               "-vertices" + "\"/>\n");
            streamWriter.Write("<input offset=\"1\" semantic=\"NORMAL\" source=\"#geom-" + CurrentPolymeshIndex +
                               "-normals" + "\"/>\n");
        ...
        private void WriteXmlGeometryTrianglesWithMap(PolymeshTopology polymesh)
        {
            ...
            streamWriter.Write("<input offset=\"1\" semantic=\"NORMAL\" source=\"#geom-" + CurrentPolymeshIndex +
                               "-normals" + "\"/>\n");
            streamWriter.Write("<input offset=\"2\" semantic=\"TEXCOORD\" source=\"#geom-" + CurrentPolymeshIndex +
                               "-map" + "\" set=\"0\"/>\n");
            streamWriter.Write("<p>\n");
            PolymeshFacet facet;
        ...
        private void WriteXmlLibraryMaterials()
        {
            ...
            foreach (var materialId in polymeshToMaterialId.Values.Distinct())
            {
                ...
                streamWriter.Write("<material id=\"material-" + materialId.ToString() + "\" name=\"" +
        ...
        private void WriteXmlLibraryEffects()
        {
            ...
            foreach (var materialId in polymeshToMaterialId.Values.Distinct())
            {
                ...
                streamWriter.Write("<effect id=\"effect-" + materialId.ToString() + "\" name=\"" +
                                   GetMaterialName(materialId) + "\">\n");
                ...
                streamWriter.Write("<color>" + material.Color.Red + " " + material.Color.Green + " " +
                                   material.Color.Blue + " 1.0</color>\n");
                streamWriter.Write("</diffuse>\n");
        ...
        public void WriteXmlLibraryVisualScenes()
        {
            ...
            foreach (var pair in polymeshToMaterialId)
            {
                ...
                if (IsMaterialValid(pair.Value))
                {
                    ...
                    streamWriter.Write("<technique_common>\n");
                    streamWriter.Write("<instance_material target=\"#material-" + pair.Value + "\" symbol=\"material-" +
                                       pair.Value + "\" >\n");
